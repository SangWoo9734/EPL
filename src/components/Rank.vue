<template>
    <div class="menu">
        <div @click="state = 0" class="board-menu" :style="state == 0 ? this.btnDesign : null">TEAM</div>
        <div @click="state = 1" class="board-menu" :style="state == 1 ? this.btnDesign : null">PLAYER</div>
    </div>
