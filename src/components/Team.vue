<template>
	<div>
		...
		<div class="team-info">
			<div
				class="team-detail"
				:style="`background-image : url(${team[detail]['team']['ven_image']})`"
			>
				<div class="team-detail-blur flex">
					...
					<div class="team-detail-text text-center">
						...
						<br />
						<p>
							{{ team[detail]['team']['ven_name'] }} /
							{{ team[detail]['team']['ven_city'] }}
						</p>
				...
				<div class="team-recent-detail">
					...
					<div class="accordion accordion-flush" id="accordionFlushExample">
						<div
							...
							v-for="(p, i) in Object.keys(team[detail]['squad'])"
							:key="i"
						>
							...
							>
								<div class="accordion-body p-0">
									<div
										...
										v-for="(player, j) in team[detail]['squad'][p]"
										:key="j"
									>
